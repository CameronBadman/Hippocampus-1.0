...
| 9 | Extending the non-advancing pooled and Spider controls to 2,000 steps improves exact recovery. | rejected | 0.7549 | D0 exact set changed 0.7588 to 0.7549 and D2 changed 0.7422 to 0.7305. Recall changed to 0.7516 and 0.7019 respectively. Longer training does not rescue either arm; proceed to the frozen-logit decoder ceiling. |
